...
<body>
  <div class="page-header">
    <span class="site-name">TurboScribe</span>
    <span class="tagline">YouTube to Article · turboscribe.tanisheesh.in</span>
  </div>
  <hr class="divider"/>
  ...
  <div class="page-footer">
    © ${year} TubeScribe &nbsp;·&nbsp; <a href="https://tanisheesh.in/">Made with ❤ by Tanish Poddar</a>
  </div>
  <script>
